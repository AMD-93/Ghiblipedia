...
// user inputs film title and presses submit -> form data gets passed to POST request as a parameter (?) and gets appended to the URL (???) -> axios sends request and somehow populates DB (idk how this part happens tho) confusion of the highest ordah
...
export const useFilmsStore = defineStore('films', {
  ...
  actions: {
    async postFilm(filmTitle: string) {
...
<template>
  <div>watchlist</div>
  <input type="submit" id="filmTitle" name="Film title" value="Add film" />
</template>
